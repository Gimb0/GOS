...
/*
 * Implement kmalloc as a linked lit of allocated segments.
 * Segments should be 4 bytes aligned
...
void mem_init(atag_t *atags)
{
    ...
    // Alocate space for all thos pages' metadata
    ...
    // Reserve 1MB for the kernel heap
...
void * kmalloc(uint32_t bytes)
{
    ...
    // and make the size 16 bytes aligned
    ...
    /*
     * If the best difference found is large, split the
     * current segment into two. 
    */
